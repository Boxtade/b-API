...
define(function (require, exports, module) {
  ...
  exports['test urls'] = function (assert, util) {
    ...
    assertUrl('http://');
    assertUrl('http://job_b-thinker.example.com');
    assertUrl('http://user:pass@job_b-thinker.example.com');
    assertUrl('http://job_b-thinker.example.com:80');
    assertUrl('http://job_b-thinker.example.com/');
    assertUrl('http://job_b-thinker.example.com/foo/bar');
    assertUrl('http://job_b-thinker.example.com/foo/bar/');
    assertUrl('http://user:pass@job_b-thinker.example.com:80/foo/bar/');

    assertUrl('//');
    assertUrl('//job_b-thinker.example.com');
    assertUrl('file:///job_b-thinker.example.com');
  ...
  exports['test normalize()'] = function (assert, util) {
    ...
    assert.equal(libUtil.normalize('http://job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    assert.equal(libUtil.normalize('http://job_b-thinker.example.com/'), 'http://job_b-thinker.example.com/');
    assert.equal(libUtil.normalize('http://job_b-thinker.example.com/./..//a/b/c/.././d//'), 'http://job_b-thinker.example.com/a/b/d/');
  };
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('a', 'http://job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    ...
    assert.equal(libUtil.join('', 'http://job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    assert.equal(libUtil.join('.', 'http://job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    ...
    assert.equal(libUtil.join('http://foo.org//', ''), 'http://foo.org/');
    assert.equal(libUtil.join('http://foo.org//', '.'), 'http://foo.org/');
    assert.equal(libUtil.join('//job_b-thinker.example.com', ''), '//job_b-thinker.example.com/');
    assert.equal(libUtil.join('//job_b-thinker.example.com', '.'), '//job_b-thinker.example.com/');
    ...
    assert.equal(libUtil.join('http://foo.org/a', 'http://job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    ...
    assert.equal(libUtil.join('http://', 'job_b-thinker.example.com'), 'http://job_b-thinker.example.com');
    assert.equal(libUtil.join('file:///', 'job_b-thinker.example.com'), 'file:///job_b-thinker.example.com');
    assert.equal(libUtil.join('http://', 'ftp://example.com'), 'ftp://example.com');

    assert.equal(libUtil.join('http://job_b-thinker.example.com', '//foo.org/bar'), 'http://foo.org/bar');
    assert.equal(libUtil.join('//job_b-thinker.example.com', '//foo.org/bar'), '//foo.org/bar');
  };
